 ...
 * 
 */
public class MultipleActuatorEditPart extends CSAbstractEditPart {
   ...
   */
  public MultipleActuatorEditPart(IControlStructureEditorDataModel model,
      String stepId) {
  ...
  protected IFigure createFigure() {
    ...
    tmpFigure.setToolTip(new Label(Messages.MultipleActuator));
    return tmpFigure;
  }
