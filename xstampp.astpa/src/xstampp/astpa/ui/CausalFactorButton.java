...
public class CausalFactorButton extends CellButton implements Observer, Listener, PaintListener {
   ...
   *          linking shell
   */
  public CausalFactorButton(ISeverityEntry entry, IDataModel model, Control control) {
