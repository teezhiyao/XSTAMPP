...
public interface ISubMeasurementController {
  ...
  /**
   * @return a list of {@link SubMeasurementCSComponent} that is populated when the method
   *         {@link SubMeasurementController#prepareForExport(IHazAccController, IRectangleComponent, IExtendedDataController, IControlActionController, LinkController, ISDSController)}
   *         is called<br> NOTE: This method might return <b>null<b> when called outside of an export context
   */
  List<SubMeasurementCSComponent> getCausalComponents();
