...
public class STPAResultsTable extends StandartEditorPart{
	...
	public void createPartControl(Composite parent) {
		this.dataModel =(DataModelController) ProjectManager.getContainerInstance().getDataModel(getProjectID());
	    ...
	    ltlColumn.setText("Security Constraint");
	...
	private void fetchInput(){
		...
		for(AbstractLTLProvider rule: dataModel.getExtendedDataController().getAllScenarios(true,true,false)){
