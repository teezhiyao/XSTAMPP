...
public enum CausalFactorEnum implements CausalFactorInterface {
    ...
    COMPONENT_FAILURE_CHANGES_OVER_TIME("Component failure Changes over time", Intention.UNINTENTIONAL),
    ...
    INADEQUATE_OR_MISSING_FEEDBACK("Inadequate or missing feedback", Intention.UNINTENTIONAL),
    INADEQUATE_OPERATIONS("Inadequate operations", Intention.UNINTENTIONAL),
    FEEDBACK_delays("Feedback Delays", Intention.UNINTENTIONAL),
