...
package xstampp.stlsa.ui.causalScenarios;
...
public class CausalScenariosView extends AbstractFilteredEditor {
	private static final String ID = "xstampp.stlsa.ui.causalScenarios";
	private static final String UCA="unsecure control actions";

  private static final String PREFIX = "S1.";
  protected String[] columns = new String[] { "ID","Causal Scenario","Security Constraint" };
