...
import xstampp.stlsa.ui.SecATableFilter;
...
public class CSCView extends AbstractFilteredTableView {
	 ...
	 * 
	 */
	public static final String ID = "stlsa.steps.step2_3"; //$NON-NLS-1$
	 ...
	 */
	public CSCView() {
		super(new SecATableFilter(), new String[] { Messages.ID, StlsaMessages.UnsecureControlActions, Messages.ID,
				StlsaMessages.CorrespondingSecurityConstraints });
	...
	public String getTitle() {
		return StlsaMessages.CorrespondingSecurityConstraints;
	}
