...
package xstampp.stlsa.controlstructure;
...
public class CSEditor extends CSAbstractEditor {
  ...
  public PaletteRoot getPaletteRoot() {
    ...
    ImageDescriptor imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/controller_palette_32.png"); //$NON-NLS-1$
    ...
    entry = new CombinedTemplateCreationEntry(Messages.Controller + "", Messages.CreateController,
        ...
        new CSModelCreationFactory(ComponentType.CONTROLLER, this.getRoot()), imgDesc,
        imgDescLarge);
    componentElements.add(entry);
    this.toolEntryToComponentType.put(ComponentType.CONTROLLER, entry);
    //Multiple Controller added here
    entry = new CombinedTemplateCreationEntry(Messages.MultipleController + "", Messages.CreateMultipleController,
        ComponentType.MULTIPLE_CONTROLLER,
        new CSModelCreationFactory(ComponentType.MULTIPLE_CONTROLLER, this.getRoot()), imgDesc,
        imgDescLarge);
    componentElements.add(entry);
    this.toolEntryToComponentType.put(ComponentType.MULTIPLE_CONTROLLER, entry);    
    
    imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/actuator_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/actuator_palette_40.png"); //$NON-NLS-1$
    entry = new CombinedTemplateCreationEntry(Messages.Actuator, Messages.CreateActuator,
    ...
    //Multiple Actuator added here
    entry = new CombinedTemplateCreationEntry(Messages.MultipleActuator, Messages.CreateMultipleActuator,
        ComponentType.MULTIPLE_ACTUATOR,
        new CSModelCreationFactory(ComponentType.MULTIPLE_ACTUATOR, this.getRoot()), imgDesc, imgDescLarge);
    componentElements.add(entry);
    this.toolEntryToComponentType.put(ComponentType.MULTIPLE_ACTUATOR, entry);
    
    
    imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/process_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/process_palette_40.png"); //$NON-NLS-1$
    entry = new CombinedTemplateCreationEntry(Messages.ControlledProcess,
        Messages.CreateControlledProcess,
    ...
    //Multiple ControlledProcess here
    entry = new CombinedTemplateCreationEntry(Messages.MultipleControlledProcess,
        Messages.CreateMultipleControlledProcess,
        ComponentType.MULTIPLE_CONTROLLED_PROCESS,
        new CSModelCreationFactory(ComponentType.MULTIPLE_CONTROLLED_PROCESS, this.getRoot()), imgDesc,
        imgDescLarge);
    componentElements.add(entry);
    this.toolEntryToComponentType.put(ComponentType.MULTIPLE_CONTROLLED_PROCESS, entry);
    
    imgDesc = Activator.getImageDescriptor("/icons/buttons/controlstructure/sensor_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/sensor_palette_40.png"); //$NON-NLS-1$
    entry = new CombinedTemplateCreationEntry(Messages.Sensor, Messages.CreateSensor,
    ...
    entry = new CombinedTemplateCreationEntry(Messages.MultipleSensor, Messages.CreateMultipleSensor,
        ComponentType.MULTIPLE_SENSOR,
        new CSModelCreationFactory(ComponentType.MULTIPLE_SENSOR, this.getRoot()), imgDesc, imgDescLarge);
    componentElements.add(entry);
    this.toolEntryToComponentType.put(ComponentType.MULTIPLE_SENSOR, entry);
    
    imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/Feedback_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/Feedback_palette_40.png"); //$NON-NLS-1$
    entry = new CombinedTemplateCreationEntry("Feedback", "Create a Feedback Component",
    ...
    imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/controlAction_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/controlAction_palette_40.png"); //$NON-NLS-1$
    ...
    imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/controlAction_List_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/controlAction_List_palette_40.png"); //$NON-NLS-1$
    ...
    imgDesc = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/component_palette_32.png"); //$NON-NLS-1$
    imgDescLarge = Activator
        .getImageDescriptor("/icons/buttons/controlstructure/component_palette_40.png"); //$NON-NLS-1$
    entry = new CombinedTemplateCreationEntry("Other Component",
        "Create an undefined Component that has no Type", ComponentType.UNDEFINED,
    ...
    entry = new CombinedTemplateCreationEntry(Messages.TextBox, Messages.CreateTextBox,
    ...
    entry = new CombinedTemplateCreationEntry(Messages.DashedBox, Messages.CreateDashedBox,
        ComponentType.DASHEDBOX,
  ...
  public void changeActiveTool(String activeTool) {
    if (this.toolEntryToComponentType.containsKey(activeTool)) {
      this.getEditDomain().getPaletteViewer()
          .setActiveTool(this.toolEntryToComponentType.get(activeTool));
      return;
    }
    for (ComponentType type : ComponentType.values()) {
      if (type.toString().equals(activeTool)) {
        this.getEditDomain().getPaletteViewer()
            .setActiveTool(this.toolEntryToComponentType.get(type));
        return;
      }
    }
